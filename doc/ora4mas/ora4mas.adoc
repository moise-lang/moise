...
.writing-paper.mas2j
----
include::../../src/examples/writePaper/agents/writing-paper.mas2j[]
----
...
.bob.asl
----
include::../../src/examples/writePaper/agents/bob.asl[]
----
...
.common-moise.asl
----
include::../../src/examples/writePaper/agents/common-moise.asl[]
----

[source,asl]
.alice.asl
----
include::../../src/examples/writePaper/agents/alice.asl[]
----
...
.common.asl
----
include::../../src/examples/writePaper/agents/common.asl[]
----

[source,asl]
.carol.asl
----
include::../../src/examples/writePaper/agents/carol.asl[]
----
